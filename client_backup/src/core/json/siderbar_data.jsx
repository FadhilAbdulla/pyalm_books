    ...
    submenuItems: [
      ...
      },
      {
        ...
        submenuItems: [
          ...
          { label: "Recurring Invoices", link: "/recurring-invoices" },
          { label: "Delivery Challans", link: "/delivery-challans" },
          { label: "Payment Recieved", link: "/payment-recieved" },
          { label: "Credit Notes", link: "/credit-notes" },
        ],
      },
      {
        label: "Purchases",
        ...
        submenuItems: [
          ...
          { label: "Recurring Expenses", link: "/recurring-expenses" },
          { label: "Bills", link: "/bills" },
          { label: "Recurring Bills", link: "/recurring-bills" },
          { label: "Payment Made", link: "/payment-made" },
          { label: "Vendor Credits", link: "/vendor-credits" },
        ],
      },
      {
        label: "Banking",
      ...
      },
      {
        ...
        submenuItems: [
          { label: "Manual Journals", link: "/manual-journal" },
          { label: "Bulk Update", link: "/bulk-update" },
          { label: "Currency Adjustments", link: "/currency-adjustments" },
          { label: "Chart of Accounts", link: "/chart-of-accounts" },
          { label: "Budgets", link: "/budgets" },
          { label: "Transaction Locking", link: "/transaction-locking" },
        ],
      },
      {
        label: "Reports",
